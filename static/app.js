...
let budgetData;
let budgetDataGeneralFund;
let budgetDataRevenues;
...
async function prepareData() {
	budgetData = await processGetRequest();
	budgetDataGeneralFund = budgetData.budgetData[0].general_fund;
	budgetDataRevenues = budgetData.budgetData[1].revenues;
	console.log(budgetData);
